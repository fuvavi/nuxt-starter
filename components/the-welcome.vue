<template>
    <div class="dark:bg-gray-900">
        <svg
            ...
            class="pointer-events-none absolute w-full top-[1px] transition-all text-primary flex-shrink-0 opacity-100 duration-[400ms] z-10"
        >
            <mask id="path-1-inside-1_414_5526" fill="white"><path d="M0 0H1440V181H0V0Z" /></mask>
        ...
        <div
            class="py-24 sm:py-32 md:py-40 relative dark:bg-gradient-to-b from-gray-950 to-gray-900 md:pb-24"
        >
            <svg
                width="100%"
                height="869"
            ...
            >
                <g clip-path="url(#clip0_184_92145)" data-v-835f5c7a="">
                    <path
                        ...
                        stroke="url(#paint0_linear_184_92145)"
                        stroke-width="2"
                        class="svg-elem-1"
                        data-v-835f5c7a=""
                    />
                    <path
                        ...
                        stroke="url(#paint1_linear_184_92145)"
                        stroke-opacity="0.5"
                        stroke-width="2"
                        class="svg-elem-2"
                        data-v-835f5c7a=""
                    ...
                    <path
                        ...
                        stroke="url(#paint2_linear_184_92145)"
                        stroke-opacity="0.25"
                        stroke-width="2"
                        class="svg-elem-3"
                        data-v-835f5c7a=""
                    ...
                    <path
                        ...
                        stroke="url(#paint3_linear_184_92145)"
                        stroke-opacity="0.1"
                        stroke-width="2"
                        class="svg-elem-4"
                        data-v-835f5c7a=""
                ...
                <defs data-v-835f5c7a="">
                    <linearGradient
                        ...
                        data-v-835f5c7a=""
                    >
                        <stop stop-color="#00DC82" stop-opacity="0" data-v-835f5c7a="" />
                        <stop offset="0.203125" stop-color="#00DC82" data-v-835f5c7a="" />
                        <stop
                            offset="0.333238"
                            stop-color="#00DC82"
                            stop-opacity="0"
                        ...
                        <stop
                            ...
                            data-v-835f5c7a=""
                        />
                        <stop offset="0.757084" stop-color="#00DC82" data-v-835f5c7a="" />
                        <stop
                            offset="0.994792"
                            stop-color="#00DC82"
                            stop-opacity="0"
                    ...
                    <clipPath id="clip0_184_92145" data-v-835f5c7a="">
                        <rect
                            ...
                            height="732"
                            fill="white"
                            transform="translate(-73 144) rotate(-8)"
                            class="svg-elem-5"
                            data-v-835f5c7a=""
                        />
                    </clipPath>
            ...
            <div class="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl gap-16 sm:gap-y-24 flex flex-col">
                <div class="text-center relative z-[1]">
                    <div class="mb-10">
                        <a href="https://nuxt.com/blog/v3-13" target="_blank" class=""
                            ><span
                                class="inline-flex items-center text-sm px-2.5 py-1.5 bg-primary-50 dark:bg-primary-400 dark:bg-opacity-10 text-primary-500 dark:text-primary-400 ring-1 ring-inset ring-primary-500 dark:ring-primary-400 ring-opacity-25 dark:ring-opacity-25 relative rounded-full font-semibold dark:hover:bg-primary-400/15 dark:hover:ring-primary-700"
                                >Nuxt v3.13 is out
                                <Icon
                    ...
                    >
                        The Intuitive<br /><span class="text-primary block lg:inline-block"
                            >Vue Framework</span
                        >
                    </h1>
                    <div class="mt-6 text-lg tracking-tight text-gray-600 dark:text-gray-300">
                        ...
                        that makes web development intuitive and powerful.<br />Create performant
                        and production-grade full-stack web apps and websites with confidence.
                    </div>
                    <div class="mt-10 flex flex-wrap gap-x-6 gap-y-3 justify-center">
                        <div class="flex flex-col gap-4">
                            <div class="flex items-center gap-2">
                                <a
                                    class="focus:outline-none disabled:cursor-not-allowed disabled:opacity-75 aria-disabled:cursor-not-allowed aria-disabled:opacity-75 flex-shrink-0 font-medium rounded-md text-sm gap-x-2.5 px-3.5 py-2.5 shadow-sm text-white dark:text-gray-900 bg-primary-500 hover:bg-primary-600 disabled:bg-primary-500 aria-disabled:bg-primary-500 dark:bg-primary-400 dark:hover:bg-primary-500 dark:disabled:bg-primary-400 dark:aria-disabled:bg-primary-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500 dark:focus-visible:outline-primary-400 inline-flex items-center"
                                ...
                                >
                                    ...
                                    Nuxt in 100 Seconds
                                    <Icon
                                        name="material-symbols:motion-play-outline-rounded"
                                        class="ml-1 text-base"
                                    />
                                </button>
                            </div>
                            <label class="w-full"
                                ><div class="relative">
                                    <input
                                        type="text"
                                        class="relative block w-full disabled:cursor-not-allowed disabled:opacity-75 focus:outline-none border-0 form-input rounded-md placeholder-gray-400 dark:placeholder-gray-500 text-sm px-3.5 py-2.5 shadow-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-white ring-1 ring-inset ring-gray-300 dark:ring-gray-700 focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 ps-11 pe-11"
                                        value="npx nuxi@latest init <my-app>"
                                    />
                                    <div class="cursor-copy absolute inset-0" />
                                    <span
                                        class="absolute inset-y-0 start-0 flex items-center pointer-events-none px-3.5"
                                        ><span
                                            class="iconify i-ph:terminal flex-shrink-0 text-gray-400 dark:text-gray-500 h-5 w-5"
                                            aria-hidden="true"
                                            style="" /></span
